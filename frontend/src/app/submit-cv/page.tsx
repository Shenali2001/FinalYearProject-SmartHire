        ...
        <div className="lg:col-span-2">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-3 xl:grid-cols-6">
              {jobTypes.map((t) => {
                ...
                return (
                  <div key={t} onClick={() => setSelectedJobType(t)} className={["flex h-11 items-center justify-center rounded-xl border text-sm font-medium transition cursor-pointer", active ? "border-gray-900 bg-gray-900 text-white shadow" : "border-gray-200 bg-white text-gray-700 hover:border-gray-300 hover:bg-gray-50"].join(" ")}>{t}</div>
                );
              })}
            </div>
          </div>
          ...
          <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="relative mt-5">
              <select value={selectedPosition} onChange={(e) => setSelectedPosition(e.target.value)} className="w-full appearance-none rounded-xl border border-gray-200 bg-white px-4 py-3 pr-10 text-sm text-gray-700 outline-none transition focus:border-gray-400">
          ...
          <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="mx-auto mt-8 px-6 pb-2"><div className={["inline-flex h-11 w-full items-center justify-center rounded-xl bg-gray-900 px-6 text-sm font-semibold text-white shadow hover:opacity-90", !selectedJobType || !selectedPosition || !file ? "cursor-not-allowed opacity-50" : ""].join(" ")}>Submit Application</div></div>
          </div>
        </div>

        {/* RIGHT: PREVIEW (tall, sticky, inner scroll) */}
        <div className="lg:sticky lg:top-6">
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm lg:h-[calc(100vh-1.5rem)] lg:max-h-[calc(100vh-1.5rem)] flex flex-col overflow-hidden">
            ...
            <div className="min-h-0 flex-1 overflow-y-auto pr-2">
              <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                <div className="text-center text-[20px] font-extrabold tracking-tight text-gray-900">Shenali Hirushika</div>
                <Divider />
                <div className="flex flex-wrap items-center justify-center gap-3 text-[13px] text-gray-700">
                  <div className="flex items-center gap-2"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 6l8 6 8-6" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/></svg><div>shenali123@gmail.com</div></div>
                  <div className="flex items-center gap-2"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 6l8 6 8-6" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/></svg><div>0722640409</div></div>
                  <div className="flex items-center gap-2"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2a7 7 0 017 7c0 5-7 13-7 13S5 14 5 9a7 7 0 017-7zm0 9a2 2 0 100-4 2 2 0 000 4z" fill="currentColor"/></svg><div>piliyndala, Colombo, Sri Lanka</div></div>
                </div>
                <Divider />
                ...
                <div className="mt-3 text-[13px] leading-6 text-gray-800">Software engineer with 3+ years of experience in web and mobile application development. Skilled in full‑stack development using modern frameworks like React, Next.js, and Spring Boot.</div>
                <Divider />
                ...
                <div className="mt-3"><div className="text-[13px] font-semibold text-gray-900">University of Westminster, BSc (Hons) Computer Science, 2022 – Present</div><div className="mt-4 text-[13px] text-gray-800">First‑Class Honours Expected</div><div className="mt-6 text-[13px] font-semibold text-gray-900">Royal College Colombo, Advanced Level Certificate, 2018 – 2021</div><div className="mt-2 text-[13px] text-gray-800">Distinction in Mathematics</div></div>
                <Divider />
                ...
                <div className="mt-3 text-[13px] leading-6 text-gray-800">Python, JavaScript, Java, TypeScript, React, Next.js, Node.js, Spring Boot, Redux, Context API, SQL, MongoDB, PostgreSQL, Firebase, Git, JAX, Bootstrap, Tailwind CSS</div>
                <Divider />
                ...
                <div className="mt-3 space-y-4">
                  <Bullet><div><div className="font-semibold text-gray-900">Prime Booking App:</div><div>A web app for booking tickets. <span className="font-medium">Technologies:</span> Spring Boot, Next.js, MongoDB.</div></div></Bullet>
                  <Bullet><div><div className="font-semibold text-gray-900">Portfolio Website:</div><div>Showcasing programming services. <span className="font-medium">Technologies:</span> React, Context API, SQL, MongoDB, PostgreSQL, Firebase, Git, JAX.</div></div></Bullet>
                </div>
                <Divider />
                ...
                <div className="mt-3 space-y-4">
                  <Bullet><div><div className="text-gray-900">VVH Solutions, Associate Software Engineer, 2025 - Present, developed scalable web applications using Next.js and MongoDB</div></div></Bullet>
                  <Bullet><div><div className="text-gray-900">Zynovatex, Intern Software Engineer, 2024 - 2024, Assisted in building a loan management system using Spring Boot and PostgreSQL</div></div></Bullet>
                </div>
              </div>
            </div>
          </div>
